<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        do{
            ...
            $sql = "UPDATE countries SET name_country = '$name' WHERE id = $id"; 
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" name="name_country" type="text" value="<?php echo $name; ?>">
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-primary" type="button">Alterar País</button>
                                    </form>
                                </div>
                            </div>
                        </div>
