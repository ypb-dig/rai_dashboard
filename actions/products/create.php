        ...
        do{
            ...
            if($main_img !== null){
                ...
                if($ext == true){
                    ...
                    $insert = "INSERT INTO listings (main_img, img1, img2, img3, name_listing, sign_listing, price_listing, address_listing, description_listing, datetime, idregion) VALUES ('$nome_mainimg', '', '', '', '$name_listing', '$sign_listing', '$price_real', '$address_listing', '$description_listing', NOW(), $idregion)";
